...
<ul class="sidebar-menu">
  ...
  <li><a href="./pages/manage_user.php"><i class="fas fa-users-cog"></i><span>Manage</span></a></li>
  ...
  <ul class="activity-list">
    ...
    <li class="activity-item">
      <div class="activity-icon <?php echo $activity['type']; ?>">
        <i class="fas fa-<?php echo $activity['type'] === 'add' ? 'plus' : ($activity['type'] === 'edit' ? 'edit' : 'trash'); ?>"></i>
      </div>
